...
public class OneD 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("Length of i[]="+i.length);     //7
		System.out.println("Element of 3rd index in a[]="+a[3]);   //4
		int sum=a[8]+b[2];		
		System.out.println("a[8]+b[2]="+sum);   //9+13=22
		...
		{
			System.out.print(f[l]+" ");     // Ascending order
		}
		System.out.println();
		System.out.println("Reverse sorted f[]");
		for(int m=f.length-1;m>=0; m--)
		{
			System.out.print(f[m]+" ");     // Descending order
		}	
